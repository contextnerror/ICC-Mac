...
2024-02: With the update to Ice Cream Calculator 4, some larger changes have been made to the application. It is possible some of the instructions are now obsolete and may need to be corrected.
...
If you're not having any problems but just want to say hi, you can also still send me an email. It's nice to confirm every once in a while that people can still find it.
